<form wire:submit="create" action="/create-post" method="POST">
  ...
  <div class="form-group">
    ...
    <input wire:model="title" {{old('title')}} name="title" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="" autocomplete="off" />
    @error('title')
